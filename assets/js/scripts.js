        ...
        const chordImagesBase64 = {
            guitar: {
                // Acordes mayores
                'A#': { main: 'data:image/png;base64,REEMPLAZA_CON_TU_BASE64_A#' },
                'Bb': { main: 'data:image/png;base64,REEMPLAZA_CON_TU_BASE64_Bb' },
                'B': { main: 'data:image/png;base64,REEMPLAZA_CON_TU_BASE64_B' },
